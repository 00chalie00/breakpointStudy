...
class DataService {
    ...
    func uploadPost(message: String, uid: String, groupKey: String?, completion: @escaping (_ success: Bool) -> ()) {
        if groupKey != nil {
            //***** send to group ref *****
        } else {
    ...
    func getEmail(quary: String, handler: @escaping (_ emailArray: [String]) -> ()) {
